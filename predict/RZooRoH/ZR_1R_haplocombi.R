...
freqfile  <- '../input/allele_frequencies.txt'
...
my.model.pp  <- zoomodel(K=2, predefined=FALSE,layers=FALSE)
...
my.model.pm  <- zoomodel(K=2, predefined=FALSE,layers=FALSE)
...
my.model.mp  <- zoomodel(K=2, predefined=FALSE,layers=FALSE)
...
my.model.mm  <- zoomodel(K=2, predefined=FALSE,layers=FALSE)
